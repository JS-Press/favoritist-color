...
function Signup({ fav, onLogin, colors, loadingColors, shuffle }){
  ...
  const SignUpStyle = {
      backgroundColor: `${fav}`, color: `black`, width: 100, fontSize: 20, borderColor: `${fav}`, borderRadius: 50, fontWeight: 'bold', textDecoration: 'none', padding: 8, outlineStyle: 'solid', margin: 10, marginBottom: -20
    }
  const searchStyle = {
